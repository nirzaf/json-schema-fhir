...
const yogaDefaultFormatError_js_1 = require("./utils/yogaDefaultFormatError.js");
...
class YogaServer {
    constructor(options) {
        ...
        this.maskedErrorsOpts =
            options?.maskedErrors === false
                ? null
                : {
                    formatError: yogaDefaultFormatError_js_1.yogaDefaultFormatError,
        ...
        this.plugins = [
            ...
            options?.context != null &&
                (0, core_1.useExtendContext)(async (initialContext) => {
                    if (options?.context) {
            ...
            ...(options?.plugins ?? []),
            (0, useLimitBatching_js_1.useLimitBatching)(options?.batchingLimit),
    ...
    async getResultForParams({ params, request, }, ...args) {
        try {
            ...
            if (result == null) {
                ...
                result = await (0, processRequest_js_1.processRequest)({
                    params,
                    enveloped,
                });
            }
    ...
    async getResponse(request, ...args) {
        ...
        const response = await (0, processRequest_js_1.processResult)({
            request,
            result,
            fetchAPI: this.fetchAPI,
...
function createYoga(options) {
    ...
    return (0, server_1.createServerAdapter)({
        baseObject: server,
