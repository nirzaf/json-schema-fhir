...
import { GraphQLServerInject, YogaInitialContext, FetchAPI, GraphQLParams } from './types.cjs';
import { ExecutorResult, Plugin } from './plugins/types.cjs';
...
export declare type YogaServerOptions<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>, TRootValue> = {
    ...
    schema?: YogaSchemaDefinition<TUserContext & TServerContext & YogaInitialContext, TRootValue>;
    /**
     * Envelop Plugins
...
export declare type YogaServerInstance<TServerContext, TUserContext, TRootValue> = ServerAdapter<TServerContext, YogaServer<TServerContext, TUserContext, TRootValue>>;
export declare function createYoga<TServerContext extends Record<string, any> = {}, TUserContext extends Record<string, any> = {}, TRootValue = {}>(options: YogaServerOptions<TServerContext, TUserContext, TRootValue>): YogaServerInstance<TServerContext, TUserContext, TRootValue>;
